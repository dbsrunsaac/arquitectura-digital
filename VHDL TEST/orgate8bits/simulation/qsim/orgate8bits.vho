...
ARCHITECTURE structure OF orgate8bits IS
...
-- Equation(s):
-- \C~0_combout\ = ( \B[0]~input_o\ ) # ( !\B[0]~input_o\ & ( \A[0]~input_o\ ) )
...
-- Equation(s):
-- \C~1_combout\ = ( \B[1]~input_o\ & ( \A[1]~input_o\ ) ) # ( !\B[1]~input_o\ & ( \A[1]~input_o\ ) ) # ( \B[1]~input_o\ & ( !\A[1]~input_o\ ) )
...
-- Equation(s):
-- \C~2_combout\ = ( \B[2]~input_o\ ) # ( !\B[2]~input_o\ & ( \A[2]~input_o\ ) )
...
-- Equation(s):
-- \C~3_combout\ = ( \B[3]~input_o\ ) # ( !\B[3]~input_o\ & ( \A[3]~input_o\ ) )
...
-- Equation(s):
-- \C~4_combout\ = ( \A[4]~input_o\ & ( \B[4]~input_o\ ) ) # ( !\A[4]~input_o\ & ( \B[4]~input_o\ ) ) # ( \A[4]~input_o\ & ( !\B[4]~input_o\ ) )
...
-- Equation(s):
-- \C~5_combout\ = ( \B[5]~input_o\ ) # ( !\B[5]~input_o\ & ( \A[5]~input_o\ ) )
...
-- Equation(s):
-- \C~6_combout\ = ( \A[6]~input_o\ ) # ( !\A[6]~input_o\ & ( \B[6]~input_o\ ) )
...
-- Equation(s):
-- \C~7_combout\ = ( \B[7]~input_o\ ) # ( !\B[7]~input_o\ & ( \A[7]~input_o\ ) )
